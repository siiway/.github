**English Version**: [`GitHub`](https://github.com/siiway/.github/blob/main/CODE_OF_CONDUCT.en.md) / [`SiiWay Team Home`](https://siiway.org/en_us/about/code-of-conduct)

# SiiWay 行为准则

## 对代码中 AI 使用的约束

1. **禁止** 使用 **AI Agent** (如 Manus, Trae, Cursor) 进行涉及对已有功能进行较大改动的开发
2. AI 生成代码必须经 **100% 人工检查** 以及 **基本功能可用性 & 安全性测试** 方可提交
3. **必须** 在任何使用 AI 编写的 **文档顶部** 注明其由 AI 编写
...
当事件发生时，及时报告非常重要。要报告可能的违规行为，**请访问 [https://siiway.org/about/report.html](https://siiway.org/zh/about/report.html) 以获取可用的举报方式**。
...
本分级措施的灵感来源于 [Mozilla 行为准则团队](https://github.com/mozilla/inclusion) 的工作。
